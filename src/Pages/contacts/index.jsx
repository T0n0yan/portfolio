...
const Contacts = () => {
    return (<div className='L-contacts-container G-flex G-flex-column'>
        <div className="G-container">
            ...
            <div className='L-contacts-box G-flex   G-flex-column G-align-center '>
                <div className='L-tel-number G-flex G-align-center'>
                    ...
                    <a className='telegram' href="https://web.telegram.org/z/#570038355" target='_blank'><i  className='icon-telegram'/></a>
                </div>
                <div className=''>
                    <a href=""><i className='icon-gmail'></i></a>
